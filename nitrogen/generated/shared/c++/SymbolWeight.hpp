...
namespace margelo::nitro {
  ...
  // C++ SymbolWeight <> JS SymbolWeight (union)
  template <>
  struct JSIConverter<margelo::nitro::nitrosymbols::SymbolWeight> final {
    static inline margelo::nitro::nitrosymbols::SymbolWeight fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      switch (hashString(unionValue.c_str(), unionValue.size())) {
        ...
        default: [[unlikely]]
          throw std::invalid_argument("Cannot convert \"" + unionValue + "\" to enum SymbolWeight - invalid value!");
      }
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, margelo::nitro::nitrosymbols::SymbolWeight arg) {
      switch (arg) {
        ...
        default: [[unlikely]]
          throw std::invalid_argument("Cannot convert SymbolWeight to JS - invalid value: "
